...
if __name__ == "__main__":
    ...
    user = pd.read_csv(data_path+'ml-1m/users.dat',sep='::',header=None,names=unames, encoding='latin-1')
    rnames = ['user_id','movie_id','rating','timestamp']
    ratings = pd.read_csv(data_path+'ml-1m/ratings.dat',sep='::',header=None,names=rnames, encoding='latin-1')
    mnames = ['movie_id','title','genres']
    movies = pd.read_csv(data_path+'ml-1m/movies.dat',sep='::',header=None,names=mnames, encoding='latin-1')
